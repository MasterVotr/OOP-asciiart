...
/**
 * Specialized file image importer class for importing images from JPG formatted files
 * @param path
 */
class JPGFileImageImporter(path: String) extends FileImageImporter(path) {
